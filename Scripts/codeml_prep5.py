...
# -------------------------
def newick_unroot_with_foreground(newick_tree, gene, foreground_species1, foreground_species2, data_dir):
    ...
    for leaf in t.iter_leaves():
        if leaf.name in foreground_species1:
            leaf.name += " #1"
        if leaf.name in foreground_species2:
            leaf.name += " #2"
...
if __name__ == "__main__":
    ...
    foreground1 = {"Ailuropoda_melanoleuca", "Dasypus_novemcinctus",
                  ...
                  "Halichoerus_grypus", "Lontra_canadensis", 
                  "Meles_meles", "Mirounga_leonina", 
                  "Mustela_erminea", "Phoca_vitulina",
                  "Ursus_americanus", "Ursus_arctos"}
    foreground2 = {"Meriones_unguiculatus", "Rattus_norvegicus",
