...
#Define paths
base = os.getcwd()
data = os.path.join(base, "3data")
result = os.path.join(base, "3results")
tree = os.path.join(base, "full_omm_tree.nwk")
gene_list = ["SOX2", "NANOG", "POU5F1", "IGF1R", "IGF2R", "IGFBP5", "PAPPA2"]
